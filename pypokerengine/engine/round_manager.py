...
class RoundManager:
  ...
  def start_new_round(self, round_count, small_blind_amount, ante_amount, table):
    ...
    start_msg = self.__round_start_message(round_count, state)
  ...
  @classmethod
  def __round_start_message(self, round_count, state):
    players = state['table'].seats.players
    gen_msg = lambda idx: (players[idx].uuid, MessageBuilder.build_round_start_message(round_count, idx, state))
